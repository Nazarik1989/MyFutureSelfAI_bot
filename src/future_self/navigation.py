...
HELP_TOPICS = {
    "quick": (
        ...
        "4. Сделай health check-in.\n5. При необходимости открой раздел «Врач».",
    ),
    "features": (
        "Что умеет бот",
    ...
    "privacy": (
        "Конфиденциальность",
        "Бот работает только в личном чате. Личные карточки, health-данные и Telegram ID "
        "не включаются в меню, callback data и диагностические логи.",
    ),
    "safety": (
        "Здоровье и безопасность",
        "Health Track не ставит диагнозы и не назначает лечение. При тревожных симптомах "
        "обращайся за срочной медицинской помощью.",
    ),
}
