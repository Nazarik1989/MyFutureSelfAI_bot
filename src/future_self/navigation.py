...
HELP_TOPICS = {
    ...
    "voice": (
        ...
        "«удали все неактуальные задачи». Массовое действие всегда показывает список и просит "
    ...
    "drafts": (
        ...
        "preview, /inbox — последние сохранённые записи. /cleanup_drafts удаляет только активные "
        "черновики после подтверждения. Сроки и состояние сохранённых задач находятся в /tasks.",
    ),
    "tasks": (
        "✅ Задачи и напоминания",
        ...
        "напоминание и безопасно удалить задачу.\n\n"
